...
You can contribute data to the data base through [this](https://slesche.github.io/acdc-entry/) form:

## add_data_from_website
This folder contains script for adding submissions received via the submission website to ACDC. Submissions should be stored in add_data_from_website/data.
