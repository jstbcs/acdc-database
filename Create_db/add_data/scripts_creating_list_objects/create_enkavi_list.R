#  CREATE NESTED LIST OBJECT TO READ IN ENKAVI ET AL DATA INTO DB ############################
...
publication_df <- readxl::read_excel("./Create_db/add_data/Book.xlsx", "publication_table", range = "A11:I11", 
...
# save list object -------------------------------------------------------------
saveRDS(pub, file="./Create_db/add_data/enkavi_list.RData")
