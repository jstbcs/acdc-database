...
raw_data_study1$within_identifier = ifelse(raw_data_study1$trial > 36, "odd", "even")
raw_data_study2$within_identifier = ifelse(trial > 36, 1, 2)
raw_data_study3$within_identifier = 1
...
write.csv(test_nowithin, "~/../Downloads/raw_nowithin.csv")
